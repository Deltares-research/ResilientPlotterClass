...
file_path_guide_old = glob.glob(os.path.join(dir_path_guide_out, '_guides', '*.ipynb'))
file_path_guide_in = glob.glob(os.path.join(dir_path_guide_in, '*.ipynb'))
...
file_path_guide_rst = glob.glob(os.path.join(dir_path_guide_out, '_guides', '*.rst'))
...
file_guides = [os.path.basename(file_path).replace('.rst', '') for file_path in file_path_guide_rst]
file_guides.extend(os.path.basename(file_path).replace('.ipynb', '') for file_path in file_path_guide_out)
